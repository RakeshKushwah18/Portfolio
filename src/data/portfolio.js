...
export const projects = [
...
},
  {
    ...
    learned: 'Context API is powerful for cart state when structured well. Learned to avoid unnecessary re-renders with proper memoization.',
  },
  {
...
export const experience = [
  {
    ...
    org: 'Freelance / Open Projects',
    duration: '2024 — Present',
    description: 'Building responsive web applications and landing pages with React, Next.js and modern JavaScript.',
    responsibilities: [
      'Developing responsive React applications from design specs',
      'Integrating REST APIs with clean frontend architecture',
      'Optimising performance and Core Web Vitals',
  ...
  },
  {
    ...
    duration: '2023 — 2024',
    description: 'Built full-stack MERN applications including dashboards and e-commerce frontends.',
    responsibilities: [
      'Building full-stack apps with React, Node, Express and MongoDB',
      'Designing REST API endpoints and data models',
